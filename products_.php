        ...
        <table class="layui-table">
           ...
           ?>
            <tr>
                ...
                <td>
                    <a type="button" href="products_edit.php?product_id=<?php echo $v['product_id']?>" class="layui-btn layui-btn-primary layui-border-blue">edit product</a>
                    <a type="button" href="products_delete.php?product_id=<?php echo $v['product_id']?>" class="layui-btn layui-btn-primary layui-border-red">delete product</a>
                </td>
            </tr>
            <?php }?>
            </tbody>
