    ...
    <form class="layui-form layui-form-pane"   method="post" enctype="multipart/form-data">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" title="UPC should strictly include 12 numbers" required pattern="[1-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" name="product_UPC" value="<?php echo $info['product_UPC']?>" autocomplete="off" placeholder="product_UPC..." class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" required name="product_name" value="<?php echo $info['product_name']?>" autocomplete="off" placeholder="product_name..." class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" max="9999999.99" title="Price should be the format of 8 or 8.00, any additional cents (for price) should be in the format of 7.29 or 9.50" required pattern="[0-9]+(\\.[0-9][0-9]?)?" name="product_price" value="<?php echo $info['product_price']?>" autocomplete="off" placeholder="product_price..." class="layui-input">
            </div>
        </div>
